...
if (knitr::opts_knit$get("rmarkdown.pandoc.to") != "gfm+tex_math_dollars-yaml_metadata_block") {
  cat('<img id="github-logo" src="man/figures/logo.png" align="right" height="139" alt="logo" style="max-width: 100%; height: auto; max-height: 139px;"/>')
}
```
...
![Version](https://www.r-pkg.org/badges/version/markets)
![Release Date](https://www.r-pkg.org/badges/last-release/markets)
<!-- badges: end -->
...
if (knitr::opts_knit$get("rmarkdown.pandoc.to") == "gfm-yaml_metadata_block") {
  cat('<a style="display:block;margin:auto" href="https://www.youtube.com/watch?v=Kkjkny94dgU" target="_blank"><img src="http://img.youtube.com/vi/Kkjkny94dgU/0.jpg"  alt="Session Recording" width="560" height="315" border="10" /></a>')
} else {
  cat('<iframe width="560" height="315" src="https://www.youtube.com/embed/Kkjkny94dgU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')
}
```
